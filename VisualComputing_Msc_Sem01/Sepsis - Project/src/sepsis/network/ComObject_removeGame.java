 ...
 * @since 19.12.12
 */
public class ComObject_removeGame implements IComObject {
	...
	/**
	 * Erzeugt ein neues ComObject_removeGame Objekt, das zum Austausch von Daten mit dem Server benötigt wird.
	 * 
	 ...
	 * @since 19.12.12
	 */
	public ComObject_removeGame(String clientID, String clientKey, String gameID, String gameOwnerKey){
